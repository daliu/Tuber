...
(function() {
  ...
  var sites = [
    ...
    {url:'http://bdrive.berkeley.edu/', name:'Srika Pawar: $12', description:'Google Drive for Berkeley.', tags: ['Computer Science']},
    ...
    {url:'http://services.housing.berkeley.edu/c1c/static/index.htm', name:'Matthew Hsu: $13', description:'Cal 1 Card.', tags: ['Earth and Planetary Science']},
    {url:'https://calnet.berkeley.edu/directory/index.pl', name: 'Czarinah Libang: $12', description:'Stalk Search for people', tags: ['English']},
    {url:'http://ls.berkeley.edu/', name:'Lekha Reddy: $11', tags: ['Film']},
    {url:'http://chemistry.berkeley.edu/', name:'Lauren Kelly: $13', tags: ['French']},
    {url:'http://coe.berkeley.edu/', name:'Derek Qiu: $12', tags: ['German']},
    {url:'http://nature.berkeley.edu/site/index.php', name:'Sarah Lin: $14', tags: ['Integrative Biology']},
    {url:'http://www.haas.berkeley.edu/', name:'Dylan Staats: $13', tags: ['Italian']},
    {url:'http://easybib.com/', name:'Andrew Millman: $10', description:'Easily make a bibliography in MLA format.', tags: ['Mathematics']},
    {url:'http://oneclass.com/freetextbooks', name:'Penny Xu: $0.01', tags: ['Middle Eastern Studies']},
    {url:'http://beta.classmint.com/', name:'Lyndsie Katz: $15',description:'An interactive browser-ba.', tags: ['Molecular and Cell Biology']},
    {url:'http://s.tudy.it/twkpdup', name:'Diane Mannion: $16',description:'Make or all of your classes. (Get a free month of Pro with the url above.)', tags: ['Music']},
    {url:'http://uguru.me/', name:'Vincent Chen: $13', description:'Tutor someone in a Berkeley class or a skill to earn some money', tags: ['Near Eastern Studies']},
    {url:'http://www.lib.berkeley.edu/Catalogs/guide.html', name:'Austin Eng: $12', tags: ['Peace and Conflict Studies']},
    {url:'http://www.lib.berkeley.edu/Help/connecting_off_campus.html', name:'Zachary Liu: $11', tags: ['Philosophy']},
    {url:'http://telebears.berkeley.edu/', name:'Matthew Ho: $11', descriptions:'opsfj.', tags: ['Physics']},
    {url:'http://schedule.berkeley.edu/', name:'Sashank Parigi: $14', descriptions:'All the classes and their times.', tags: ['Public Health']},
    {url:'http://decal.org/courses', name:'Srishti Srivastava: $12', descriptions:'Student-run 1-2 unit P/NP classes.', tags: ['Rhetoric']},
    {url:'http://ninjacourses.com/', name:'Annie Tang: $15', descriptions:'Helps you plan out your schedule, see reviews of classes & professors', tags: ['Scandinavian']},
    {url:'http://www.ratemyprofessors.com/SelectTeacher.jsp?sid=1072', name:'Annie Shi: $14', descriptions:'Ratings for professors.', tags: ['Slavic Languages and Literatures']},
    {url:'http://bearcheck.herokuapp.com/', name:'Monica Ting: $12',  descriptions:'Get notified when a seat opens up in a class you want!', tags: ['Statistics']},
    ...
    {url:'http://www.ratemyprofessors.com/SelectTeacher.jsp?sid=1072', name:'Rhianna Smith', descriptions:'Ratings for professors.', tags: ['Slavic Languages and Literatures']},
    ...
    {url:'http://www.ratemyprofessors.com/SelectTeacher.jsp?sid=1072', name:'Courtney Shultz: $10', descriptions:'Ratings for professors.', tags: ['Slavic Languages and Literatures']},
