...
(function() {
  ...
  var sites = [
    ...
    {url:'https://auth.berkeley.edu/', name:'East Asian Languages and Cultures', description:'AKA CalNet Login - login to Berkeley services.', tags: ['East Asian Languages and Cultures']},
